...
SWEP.VisualRecoilPunchMultSights = 1 / 2.2
...
SWEP.CustomizePos = Vector(15.5, 30, 4.25)
...
SWEP.Attachments = {
    {
        ...
        Bone = "j_gun",
        Scale = Vector(1, 1, 1),
        Pos = Vector(2.25, 0, 3.625),
        Ang = Angle(0, 0, 0),
        Category = {"cod_optic","cod_rail_riser","cod_optic_g36"},
        InstalledElements = {"mount","mw3g36"},
    },
    {
        PrintName = "Barrel",
        Bone = "j_gun",
